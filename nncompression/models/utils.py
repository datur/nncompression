    ...
    for epoch in range(epochs):
        for i, data in enumerate(train_loader, 0):
            ...
            if i % 500 == 499:    # print every 1000 mini-batches
                ...
                running_error = 0.0
        # test loop
        writer.add_scalar('test accuracy', test_accuracy(test_loader, net, device), epoch)
...
def test_accuracy(test_loader, net, device):
    """
    A function that calculates the accuracy of the given network model on a given testloader

    :param test_loader: iterable collection of data separated into n number of batches
